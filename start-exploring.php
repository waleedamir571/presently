                    ...
                    <div>
                        ...
                        <div class="login-main">
                            <form class="theme-form">
                                <h2 class="text-center welcome">Start Exploring!!</h2>
                                <p class="text-center entry">Provide your details to set up your account <br> </p>
                                
                               <img class="w-100" src="assets/images/logo/explore.png" alt="">
                                <br>
                                <br>
