...
<div class="app-container d-flex">
    ...
    <main class="flex-grow-1  p-4 main-content">
        <div class="container">
            <div class="main-card rounded-4 bg-gradient-custom p-4 position-relative overflow-hidden">
              ...
              style="width: 100px; height: 60px; border: 2px solid gray; transform: rotate(12deg); border-radius: 0.5rem;">
                ...
                <section class="header-section d-flex align-items-center justify-content-between px-4">
                    ...
                    <div class="text-center">
                        <h5 class="fw-bold text-white">Welcome to a Journey of Discovery</h5>
                        <p class="fst-italic text-white">"Write Something Here"</p>
                    </div>
                    ...
                    <ul class="nav nav-tabs" id="inviteTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="email-tab" data-bs-toggle="tab"
                                data-bs-target="#email-content" type="button" role="tab" aria-selected="true">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15"
                                    ...
                                    <path
                                        ...
                                        stroke="white" stroke-width="0.875" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M7 9.25015V2.61182" stroke="white" stroke-width="0.875"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.95423 3.91242L7.00007 1.95825L5.0459 3.91242" stroke="white"
                            ...
                            <button class="nav-link" id="link-tab" data-bs-toggle="tab" data-bs-target="#link-content"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15"
                                    ...
                                    <path
                                        ...
                                        stroke="#1C0C13" stroke-width="0.875" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M5.50098 10.4167H8.49931" stroke="#1C0C13" stroke-width="0.875"
                    ...
                    <div class="tab-content  border-top-0 " id="inviteTabContent">
                        ...
                        <div class="tab-pane fade" id="link-content" role="tabpanel" aria-labelledby="link-tab">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-5">
                                    <button class="btn create"><svg xmlns="http://www.w3.org/2000/svg" width="19"
                                    ...
                                    <div class="marco-right-section">
                                        <button class="access"><svg xmlns="http://www.w3.org/2000/svg" width="15"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#1C0C13" stroke-width="0.880714" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M7.62891 1.7583V9.3207" stroke="#1C0C13"
                                                    stroke-width="0.880714" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M9.59694 8.01147L7.63002 9.9784L5.66309 8.01147"
                                                    stroke="#1C0C13" stroke-width="0.880714" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg> Download</button>
                                    </div>
            ...
            <div class="modal-body p-4">
                ...
                <div class="mt-5">
                    ...
                    <ul class="nav nav-tabs" id="customInviteTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="custom-email-tab" data-bs-toggle="tab"
                                data-bs-target="#custom-email-content" type="button" role="tab"
                                aria-controls="custom-email-content" aria-selected="true">
                                @ Collaborate
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="custom-link-tab" data-bs-toggle="tab"
                                data-bs-target="#custom-link-content" type="button" role="tab"
                                aria-controls="custom-link-content" aria-selected="false">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15"
                                    fill="none">
                                    <path
                                        ...
                                        stroke="white" stroke-width="0.777778" stroke-linecap="round"
                                        stroke-linejoin="round" />
                    ...
                    <div class="tab-content border-top-0" id="customInviteTabContent">
                        ...
                        <!-- Tab 2: Share -->
                        <div class="tab-pane fade" id="custom-link-content" role="tabpanel"
                            aria-labelledby="custom-link-tab">
                            <div class="col-md-12">
                                <div class="marco-card">
                                    <div class="marco-left-section">
                                        <img src="assets/images/logo/user1.png" alt="">
